...
public class ModBlocks {
    ...
    public static final Block WHITE_LILY_OF_THE_VALLEY = registerDyeableFlower("white_lily_of_the_valley", MapColor.WHITE);
    public static final Block ORANGE_LILY_OF_THE_VALLEY = registerDyeableFlower("orange_lily_of_the_valley", MapColor.ORANGE);
    public static final Block MAGENTA_LILY_OF_THE_VALLEY = registerDyeableFlower("magenta_lily_of_the_valley", MapColor.MAGENTA);
    public static final Block LIGHT_BLUE_LILY_OF_THE_VALLEY = registerDyeableFlower("light_blue_lily_of_the_valley", MapColor.LIGHT_BLUE);
    public static final Block YELLOW_LILY_OF_THE_VALLEY = registerDyeableFlower("yellow_lily_of_the_valley", MapColor.YELLOW);
    public static final Block LIME_LILY_OF_THE_VALLEY = registerDyeableFlower("lime_lily_of_the_valley", MapColor.LIME);
    public static final Block PINK_LILY_OF_THE_VALLEY = registerDyeableFlower("pink_lily_of_the_valley", MapColor.PINK);
    public static final Block GRAY_LILY_OF_THE_VALLEY = registerDyeableFlower("gray_lily_of_the_valley", MapColor.GRAY);
    public static final Block LIGHT_GRAY_LILY_OF_THE_VALLEY = registerDyeableFlower("light_gray_lily_of_the_valley", MapColor.LIGHT_GRAY);
    public static final Block CYAN_LILY_OF_THE_VALLEY = registerDyeableFlower("cyan_lily_of_the_valley", MapColor.CYAN);
    public static final Block PURPLE_LILY_OF_THE_VALLEY = registerDyeableFlower("purple_lily_of_the_valley", MapColor.PURPLE);
    public static final Block BLUE_LILY_OF_THE_VALLEY = registerDyeableFlower("blue_lily_of_the_valley", MapColor.BLUE);
    public static final Block BROWN_LILY_OF_THE_VALLEY = registerDyeableFlower("brown_lily_of_the_valley", MapColor.BROWN);
    public static final Block GREEN_LILY_OF_THE_VALLEY = registerDyeableFlower("green_lily_of_the_valley", MapColor.GREEN);
